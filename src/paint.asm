...
endm
vertical macro
	local comp, firstCoord, secondCoord, drawLoop, exit
	comp:
		cmp coordsGot, 1
		je secondCoord
		cmp skipToSecond, 1
...
get_input macro
    local check, save, help, escape, adjust, vert, bdown, cup, cdown, bgdown, fgup, fgdown, clearAll, rect, circle, diagonAlly, diagonAllySkip, rectSkip, squareAroundMouse
	escape:
